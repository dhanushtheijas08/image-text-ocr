    ...
    var t = {
        30: (t, r, e) => {
          ...
          var o = (function (t) {
            ...
            return (
              (b.prototype = w),
              i(O, "constructor", { value: w, configurable: !0 }),
              i(w, "constructor", { value: b, configurable: !0 }),
              (b.displayName = s(w, f, "GeneratorFunction")),
              ...
              (t.mark = function (t) {
                return (
                  Object.setPrototypeOf
                    ...
                    : ((t.__proto__ = w), s(t, f, "GeneratorFunction")),
        ...
        130: (t) => {
          ...
          function e() {
            ...
            return (
              (w.prototype = L),
              a(S, "constructor", { value: L, configurable: !0 }),
              a(L, "constructor", { value: w, configurable: !0 }),
              (w.displayName = l(L, s, "GeneratorFunction")),
          ...
          t.exports = function () {
              ...
              y = function (r, c) {
                return new Promise(function (l, h) {
                  ...
                  n.push(
                    ...
                    s("[".concat(t, "]: Add ").concat(y.id, " to JobQueue")),
                    s("[".concat(t, "]: JobQueue length=").concat(n.length)),
                    p();
                });
              },
              v = (function () {
            ...
            return {
              addWorker: function (e) {
                return (
                  (r[e.id] = e),
                  s("[".concat(t, "]: Add ").concat(e.id)),
                  s("[".concat(t, "]: Number of workers=").concat(c())),
                  p(),
                  e.id
                );
              },
              ...
              return i().wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (r = $.length > 0 && void 0 !== $[0] ? $[0] : "eng"),
                        (e =
                          $.length > 1 && void 0 !== $[1] ? $[1] : g.LSTM_ONLY),
                        (n = $.length > 2 && void 0 !== $[2] ? $[2] : {}),
                        (c = $.length > 3 && void 0 !== $[3] ? $[3] : {}),
                        (f = d("Worker", S)),
                        (l = p(u(u({}, b), n))),
                        (m = l.logger),
                        (j = l.errorHandler),
                        (P = s(l, o)),
                        (_ = {}),
                        (k = "string" == typeof r ? r.split("+") : r),
                        (T = e),
                        (N = c),
                        (A =
                          [g.DEFAULT, g.LSTM_ONLY].includes(e) &&
                          !P.legacyCore),
                        (F = new Promise(function (t, r) {
                          (I = t), (G = r);
                        })),
                        (R = function (t) {
                          G(t.message);
                            ...
                            y({
                              ...
                              payload: {
                                ...
                                options: {
                                  ...
                                  gzip: P.gzip,
                                  lstmOnly:
                                    [g.DEFAULT, g.LSTM_ONLY].includes(T) &&
                                    !P.legacyLang,
                                },
                              },
                            })
                        ...
                        x(D, function (t) {
                          var r = t.workerId,
                            ...
                            a = "".concat(o, "-").concat(e);
                          if ("resolve" === n)
                            v("[".concat(r, "]: Complete ").concat(e)),
                              _[a].resolve({ jobId: e, data: i }),
                              delete _[a];
                          else if ("reject" === n) {
                            if (
                              (_[a].reject(i),
